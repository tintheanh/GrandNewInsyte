...
interface UserTaggedPostCardProps {
...
class UserTaggedPostCard extends Component<UserTaggedPostCardProps> {
  shouldComponentUpdate(nextProps: UserTaggedPostCardProps) {
...
export default connect(mapStateToProps)(
  React.memo(
    function (props: HOCHomePostCardProps) {
      ...
      return <UserTaggedPostCard {...props} navigation={navigation} />;
    },
    (prevProps, nextProps) => {
